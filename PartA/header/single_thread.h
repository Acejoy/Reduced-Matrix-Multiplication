...
{ 
  ...
  // __m256i vec_prod2 = _mm256_setzero_si256();
  // __m256i vec_prod3 = _mm256_setzero_si256();
  // __m256i vec_prod4 = _mm256_setzero_si256();
  ...
  for (int k = 0; k < N; k+=8) {
    for (int colB = 0; colB < N; colB+=2) {
      ...
      // _mm256_storeu_si256((__m256i*)&output[indexC], sum);
    }
  }
...
//         // for(int ii=0; ii<N;)
//         vec_mat_row1 = _mm256_loadu_si256((__m256i *)&matA[rowA*N+k]);
//         vec_mat_row1 = _mm256_loadu_si256((__m256i *)&matA[(rowA+1)*N+k]);
